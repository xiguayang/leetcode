 ...
 * ===>
 * Approach 1. add the sub level list into the result from the list's front: use add(0,val);
 * Approach 2. Reverse the ArrayList of LEVEL ORDER TRAVERSAL directly: use java.util.Collections.reverse()*/
public class LevelOrderBottomUp {
    ...
    public void traverseLevelOrder(List<List<Integer>> result, TreeNode root, int level){
        ...
        if(result.size() == level){
            //add the element from list's front
